          ...
          <div className="mx-auto max-w-7xl px-6 pb-96 pt-24 text-center sm:pt-32 lg:px-8">
            ...
            <div className="relative mt-6">
              <p className="mx-auto max-w-2xl text-base lg:text-lg leading-8 text-white">
                Whether you&apos;re a student looking to build your portfolio, a
                freelancer seeking clients, or an agency ready to scale,
            ...
            <div className="-mt-80">
              <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-md p-8 bg-white rounded-3xl shadow-xl ring-1 ring-gray-900/10 sm:p-10">
                  <h3 className="text-base font-semibold leading-7 text-[#1e69b5] ">
                    Get in Touch
                  </h3>
                  <Formik
                    ...
                    {({ isSubmitting }) => (
                      <Form className="mt-6 space-y-4">
                        ...
                        <div>
                          <button
                            type="submit"
                            className="block w-full rounded-md hover:bg-gradient-to-r hover:from-[#234c72] hover:to-[#3b7cb8] bg-gradient-to-r from-[#003366] to-[#1e69b5] px-3.5 py-2 text-center text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
